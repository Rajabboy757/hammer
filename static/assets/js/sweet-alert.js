...
showSwal = function (type) {
    ...
    if (type === 'basic') {
        swal.fire({
            text: 'Any fool can use a computer', confirmButtonText: 'Close', confirmButtonClass: 'btn btn-danger',
        })
        ...
        Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: 'Tanlangan talabalar buyruqqa qoshilmoqda',
        ...
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
                confirmButton: 'btn btn-success', cancelButton: 'btn btn-danger me-2'
        ...
        Swal.fire({
            title: 'Sweet!',
            text: 'Modal with a custom image.', // imageUrl: 'https://unsplash.it/400/200',
        ...
        Toast.fire({
            icon: 'success', title: 'Tizimga muaffaqiyatli kirdingiz!'
        })
    }
}
